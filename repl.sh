...
for var in SOURCE_DB_PORT SOURCE_DB_HOST SOURCE_DB_USER SOURCE_DB_PASS SOURCE_DB_NAME SOURCE_EXCLUDE_TABLE SOURCE_S3_BUCKET DEST_DB_HOST DEST_DB_PORT DEST_S3_BUCKET DEST_DB_USER DEST_DB_PASS DEST_DB_NAME DEST_CLOUDFRONT_ID; do
    if [ -z "${!var}" ]; then
